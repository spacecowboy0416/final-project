...
public interface ClosetMapper {
    ...
    // [아이템 수정] 상품 정보 수정 기능 (해당 상품을 참조하는 모든 코디 세트 정보와 자동 동기화)
    @Update("UPDATE product SET name = #{name}, brand = #{brand}, color = #{color}, season = #{season} " +
