...
public final class RecommendationPromptTemplates {
    ...
    public static final String SYSTEM_PROMPT_EN = """
            ...
            - `attributes.brand` and `attributes.pattern` should use schema enum codes when you can infer them reliably.
            - `ai_explanation` must briefly explain why this overall coordination was generated from the request, weather, and anchor item.
    ...
    public static final String SYSTEM_PROMPT_KR = """
            ...
            - `attributes.brand`, `attributes.pattern`은 추론이 가능할 때 schema enum 코드로 채우세요.
            - `ai_explanation`은 요청, 날씨, 메인 아이템을 바탕으로 왜 이 코디를 생성했는지에 대한 짧은 전체 설명입니다.
